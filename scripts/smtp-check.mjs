 ...
 * nhau - bấm nút xong không thấy thư đâu:
 *
 ...
 * đúng đường mà app gọi rồi in nguyên văn ra, nên không phải đoán nữa.
 *
...
const url = doc('VITE_SUPABASE_URL')
const khoa = doc('VITE_SUPABASE_ANON_KEY')
const email = process.argv[2]

if (!url || !khoa) {
  console.error('Chưa có VITE_SUPABASE_URL / VITE_SUPABASE_ANON_KEY trong .env.local')
  process.exit(1)
}
if (!email) {
